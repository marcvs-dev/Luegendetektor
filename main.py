...
excel_datei = pd.read_excel("dateien/Mappe1.xlsx")  #Excel
...
print_langsam(
  "Hallo! Sie sind hier da sie ein Verdächtiger im Mordfall von Ulrike sind.")

input("")  #Man muss Enter drücken damit weiterer text ausgegeben wird.
print("")

print_schneller(
  """Ich und meine Kollegen werden nun die Geschichte unserer Kenntnisse nacherzählen.
...
print_schneller(
  """Am 03.10.2022 wurde die 39-Jährige Ulrike in Suhl grauenhaft Ermordet.
...
print_schneller(
  """Ulrikes Freundin dachte sich nichts vom bellenden Hund. Sie zog sich schon passend zum Wandern an. 
...
print_schneller(
  """Es war ein Jäger welcher sofort die Polizei rief. Die Spurensicherung konnte wichtige dinge Feststellen. 
